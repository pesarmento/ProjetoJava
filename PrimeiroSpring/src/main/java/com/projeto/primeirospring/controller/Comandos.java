...
public class Comandos {
	...
	public List<String> products() {
		...
		lst.add("thumbnail: https://i.dummyjson.com/data/products/1/thumnail.jpg");
		
		lst.add("id: 2");
		lst.add("title: iPhone X");
		lst.add("description: SIM-Free, Model A19211 6.5-inch Super Retina HD display with OLED technology A12 Bionic chip");
		lst.add("price: 889");
		...
		lst.add("description: OPPO F19 is officially anounced on April 2021");
		lst.add("price: 280");
